...
public class Database {
    ...
    static {
        try {
            conn = DriverManager.getConnection(String.format("jdbc:mysql://%s:%s/%s", "127.0.0.1", "3306", "coaches"), "root", "root");
    ...
    public static void insertInformationAboutCoach(Coach coach) throws SQLException {
        String sqlInsert = "INSERT INTO `results` (`inputDataId`, `coachFound`, `detailsAboutCoachUrl`, `email`, `biography`, `image`) VALUES (?,?,?,?,?,?);";
